...
<div class="row">
    <div class="sidebar-item col-md-2 p-0">
        ...
        <li class="nav-item2">
          <a class="nav-link text-light" href="#"><h4 class="side-nav-heading">Your Profile</h4></a>
        </li>
        <?php
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="profile.php?forgot_password">Change Password</a>
        </li>
        <li class="nav-item">
