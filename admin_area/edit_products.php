...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_description" value="<?php echo $product_decription ?>" name="product_description" class="form-control">
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
if(isset($_POST['edit_product']))
{
    ...
    or $product_brands=='' $product_image1=='' or $product_image2=='' or $product_image3=='' or
    $product_price=='')
    {
    ...
    //query to upadete products

    $update_products="update `products` set category_id='$product_category',brand_id='$product_brands',
    product_decription='$product_description',product_keywords='$product_keywords',product_title='$product_title'
